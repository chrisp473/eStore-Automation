...
public class PurchaseItemWithVoucher extends eStoresBaseTest{

	@Test(groups = { "PurchaseItemWithVoucher" }, invocationCount=1)
	public void testSteps() throws Exception{
		try{
			...
			// Voucher
			basketPage.voucherInput_Textbox.inputText("InvalidCode00");
			basketPage.voucherSubmit_Button.click();
			basketPage.assertInvalidCode();
			basketPage.voucherInvalidDismiss.click();
			basketPage.assertErrorDismissed();
			basketPage.voucherInput_Textbox.inputText("AUTOMATIONVOUCHER");
