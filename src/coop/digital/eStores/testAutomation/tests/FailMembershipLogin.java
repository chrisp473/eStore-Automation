...
public class FailMembershipLogin extends eStoresBaseTest{
	...
	public void testSteps() throws Exception{
		try{
			...
			checkoutPage.membershipDisplayMemberPointsTryAgain.click();
			Thread.sleep(2500);
			
			checkoutPage.memberTryAgain_Button.click();
			checkoutPage.memberFirstName.inputText(TestHelper.getTestDataValue("FirstName"));
			checkoutPage.memberLastName.inputText(TestHelper.getTestDataValue("LastName"));
			
			checkoutPage.membershipYes_Button.click();
